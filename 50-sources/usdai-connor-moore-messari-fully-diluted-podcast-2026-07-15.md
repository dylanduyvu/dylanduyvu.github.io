...
- Thomas/Barkr follow-up: staged, gist only per drafting rules, continuing the 2026-07-01 thread rather than opening cold. The one question July 1 left open: would verified operator delivery history move the guarantee's 100 to 150 basis points, or does nothing about the operator ever touch that price?
