...
# Computer-use NAP labeling batch 1 source and pre-cleanup ledger

> Preserved source for the first ten-video labeling batch and the original
> pre-cleanup 78-row ledger. It is superseded by
> [[computer-use-nap-v4-canonical-dataset|Computer-use NAP V4 canonical
> dataset]]. Do not append new canonical rows here.
