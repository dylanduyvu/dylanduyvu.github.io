...
- AMD has run backstops since 2025 (AWS, OCI, DigitalOcean, Vultr, Tensorwave, Crusoe): rent-back commitments for internal software development if capacity unsold. Vendor credit is systemic, not NVIDIA-idiosyncratic.
...
- Who measures utilization and revenue for backstop settlement and the rev share? (Still unanswered - now with take-rate economics attached.)
