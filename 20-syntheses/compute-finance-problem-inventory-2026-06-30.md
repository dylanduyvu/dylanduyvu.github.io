...
- Next direct-lender/insurer test: ask whether monitored history from existing deployments would reduce the required equity cushion, improve LTV, change pass/approval, eligibility, advance rate, guarantee/insurance terms, or pricing on the next deployment.
