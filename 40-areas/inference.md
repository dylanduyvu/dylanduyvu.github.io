...
- **Potential opportunity, not a build recommendation:** A 2026-08-19 snapshot showed five Qwen3.8-27B providers on OpenRouter, while LM Studio displayed 908,400 local downloads. OpenRouter then reported approximately 24.60 billion prompt-plus-completion tokens and 1.49 million requests for 2026-08-18. This supports both local and hosted activity with scarce early gateway supply. It does not show durable customer demand, hardware fit, achievable differentiation, or positive unit economics.
...
- **Radar scope:** The model-opportunity radar stops at potential-opportunity identification. Hardware matching, serving benchmarks, and unit economics require a separate later evidence pass because those capabilities have not yet been proved.
