...
- 2026-04-06 (Friedman/Mellor): the first investment-grade GPU deal makes the infrastructure absence VISIBLE rather than fixing it. Their counterintuitive implication: the trophy deal may WIDEN the sector's cost-of-capital spread - CoreWeave borrows near investment grade (~5.9%, 300bps of compression in two years) while everyone else stays in high-yield, and the benchmark now quantifies exactly what the missing infrastructure costs the locked-out tier. Their market-scaling list (multi-obligor models, a neocloud operator rating framework, and above all a forward curve) is the rating-agency-side version of the same catalog.
