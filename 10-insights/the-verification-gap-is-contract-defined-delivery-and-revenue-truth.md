...
projects: []
sources: [aravolta-usdai-collateral-verification-case-study-2026-07-02, usd-ai-call-harry-page-2026-06-29, deep-research-gpu-credit-post-pressure-test-2026-07-05, silicon-network-product-and-risk-model-audit-2026-07-13, ccir-gpu-compute-credit-research-audit-2026-07-22]
people: [harry-page]
orgs: [aravolta, usd-ai, silicon-network, ccir]
...
- 2026-07-22 (CCIR audit): large CoreWeave facilities use controlled accounts, asset schedules, debt-service tests, and a monthly contract-realization ratio. Cash and collateral are more directly measured than this note previously allowed. The remaining gap is the service and causal layer between machines, contracts, and changing cash.
...
- Revenue truth partially exists elsewhere: lenders with SPV cash controls and contract-realization tests can see revenue arrive; what they cannot necessarily see is why it shrank or whether the underlying service met the contract.
...
### 2026-07-22 - Cash measurement narrows the open layer

CCIR's public-facility audit corrected the broad version of this thesis. Large GPU loans already measure assets, controlled cash, debt-service coverage, and in at least one CoreWeave facility a monthly contract-realization ratio. The open layer is therefore not "did money arrive at all." It is contract-defined delivery and the reason money changed. See [[ccir-gpu-compute-credit-research-audit-2026-07-22|the full CCIR audit]].
...
Tiwari (Magnetar, No Priors ep. 152, aired 2026-02-26, captured 2026-07-08): citing Silicon Data (CEO Carmen Li), "two pieces of compute that look identical on paper have wildly different performances. Everything from reliability to cost to speed." And his open question for financing distributed inference: how to "mash together very different types of compute and try to optimize for reliability." A $22B lender volunteering that paper-identical compute is not identical is the premise under this whole note, said unprompted from the capital side; the question behind his question is who measures. Also relevant: performance-truth vendors (Silicon Data on pricing/performance telemetry) are becoming lender-visible, which pressures the machine-watching layer's occupancy but not the contract join this note names. Fifth-seat convergence, 2026-07-10 (crypto-venture call): asked why the compute-financialization layer is the thinnest on his market map, the venture researcher's unprompted answer was "how do you standardize compute... compute is very heterogeneous... how do you price it?" Lenders, researchers, raters, market-structure writers, and now venture have each independently named the same blocker.
